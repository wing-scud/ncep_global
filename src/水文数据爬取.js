...
const baseUrl = "http://apdrc.soest.hawaii.edu/erddap/griddap/hawaii_soest_8b8d_ba26_45c0.html?"
const fileName = "ncep_global";
const basePath = "D:/wxy/Node/nc-tiff-tool/public/nc/new/水文数据/"
let startDate = new Date(2021, 3, 3, 12); //+10800 3h
let endDate = new Date(2021, 4, 3, 12);
let variables = ['precip'];
let filesLength = 0
run()
async function run() {
    //每次请求一天的数据
